import { LayoutDashboard, ListTodo, Sparkles, Wallet, Trophy, Settings, BarChart3, Activity, Store, Moon, PiggyBank } from "lucide-react";
...
const mainItems = [
  ...
  { title: "নামায", url: "/namaz", icon: Moon },
  ...
  { title: "সঞ্চয়", url: "/savings", icon: PiggyBank },

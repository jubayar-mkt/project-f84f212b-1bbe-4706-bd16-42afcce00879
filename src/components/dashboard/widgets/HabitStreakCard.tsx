  ...
  return (
    <div className="block">
      <Card className="relative h-full overflow-hidden p-5 shadow-soft glass">
        <div className="absolute -right-8 -top-8 h-28 w-28 rounded-full bg-gradient-to-br from-warning/30 to-warning/5 opacity-60 blur-2xl" />
        <div className="relative space-y-3">
          <div className="flex items-center gap-2">
              ...
              <p className="text-xs font-semibold text-foreground/80">শ্রেষ্ঠ স্ট্রিক</p>
          </div>
          {loading ? (
            ...
            <>
              <div className="flex items-baseline gap-2">
                ...
                <p className="text-xs text-muted-foreground font-medium">দিন</p>
              </div>
              <p className="text-[11px] text-muted-foreground font-medium">{toBn(activeHabits)} টি সক্রিয় অভ্যাস</p>
            </>
          )}
        </div>
      </Card>
